  ...
  if (onClick) {
    return (
      <button
        type="button"
        onClick={onClick}
        className="card flex w-full items-start justify-between gap-3 text-left transition-all hover:border-brand-400 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-brand-500/40 dark:hover:border-brand-600"
      >
        {content}
      </button>
    )
